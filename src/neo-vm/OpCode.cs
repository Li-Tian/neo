namespace Neo.VM
{
    ...
    // </summary>
    /// <summary>
    /// Enumeration class, all opcodes supported by NVM.
    /// </summary>
    public enum OpCode : byte
    {
        ...
        // </summary>
        /// <summary>
        /// Call a new execution context, the script is the script of the current  execution context, 
        ...
        // </summary>
        /// <summary>
        /// Call a new execution context, the script is specified by the 20-bit hash after the instruction, 
        /// pcount specifies the number of parameters, and rvcount specifies the number of results. 
        /// Jump to the new execution context.
        /// </summary>
        CALL_E = 0xE1,
        ...
        // </summary>
        /// <summary>
        /// Call a new execution context, the script is specified by the Hash at the top of the evaluation stack, 
        /// pcount specifies the number of parameters, and rvcount specifies the number of results. 
        /// Jump to the new execution context.
        /// </summary>
        CALL_ED = 0xE2,
