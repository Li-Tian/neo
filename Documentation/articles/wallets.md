...
NEO的钱包可以自行设计和修改，但需要满足以下一系列的规则和范式
...
![Base58Check编解码](../images/wallets/privateKey-wif.png)
 ...
 Example: 
 byte[]：[0xc7,0x13,0x4d,0x6f,0xd8,0xe7,0x3d,0x81,0x9e,0x82,0x75,
...
2.使用Scrypt算法算出一个derivedkey，并将其64个字节数据分成2半，称他们为derivedhalf1和derivedhalf2
