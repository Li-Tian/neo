...
namespace Neo.SmartContract
{
    ...
    // </summary>
    /// <summary>
    /// Smart contract execution engine class, mainly responsible for Smart contracts execution and related detection functions
    /// </summary>
    public class ApplicationEngine : ExecutionEngine
    {
        ...
        /// <param name="testMode">whether it is executing in testmode </param>
        ...
        /// </summary>
        /// <param name="script">Script opcode</param>
        /// <param name="snapshot">Database snapshot</param>
        /// <param name="container">Script container</param>
        ...
        /// <param name="extraGAS">The amount of Gas required after remove the free credit</param>
