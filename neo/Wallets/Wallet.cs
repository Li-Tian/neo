...
namespace Neo.Wallets
{
    ...
    // </summary>
    /// <summary>
    /// Wallet is a abstract class，which is the super class of various wallet implementation classes。
    /// Describes the various functions that a wallet needs to perform
    /// </summary>
    public abstract class Wallet : IDisposable
    {
        ...
        /// <summary>
        /// Get the account in the wallet according to the script hash
        /// </summary>
        /// <param name="scriptHash">script hash</param>
        /// <returns>WalletAccount object</returns>
        ...
        /// <summary>
        /// Query transaction hashes related to accounts in  wallet
        /// </summary>
        /// <returns>a collection of transcation hash</returns>
        ...
        // <returns>生成的钱包账户对象</returns>
        /// <summary>
        /// create a WalletAccount object ，no paramter（create privatekey by RandomNumberGenerator）
        /// </summary>
        /// <returns>WalletAccount object</returns>
        ...
        /// <summary>
        /// create wallet account by Contract object and privatekey
        /// </summary>
        /// <param name="contract">Contract object</param>
        /// <param name="privateKey">privatekey</param>
        /// <returns>WalletAccount object</returns>
        ...
        // <returns>查询到的Coin集合</returns>
        /// <summary>
        /// Query all unspent Coins held by unlocked accounts and non-watched accounts in the specified account collection
        /// If specified account collection is null，take all the accounts in the wallet account list as the specified account collection
        /// </summary>
        /// <param name="from">specified account address set</param>
        /// <returns>Coin set</returns>
        ...
        // <returns>查询到的Coin集合</returns>
        /// <summary>
        /// 1、Query a subset of a global asset (neo, gas) meeting the specified amount in a specified unspent Coin set.
        /// (Descending search)
        /// </summary>
        /// <param name="unspents">unspent Coin set</param>
        /// <param name="asset_id">a global asset ID</param>
        /// <param name="amount">specified amount</param>
        /// <returns>Coin set</returns>
        ...
        /// <summary>
        /// Query a specified wallet account in the wallet account according to publickey
        /// </summary>
        /// <param name="pubkey">publickey</param>
        /// <returns>WalletAccount object</returns>
        ...
        /// <summary>
        /// Query available amount of the specified global asset (neo, gas) in the wallet
        /// </summary>
        /// <param name="asset_id">global asset ID</param>
        /// <returns>available amount of the specified global asset (neo, gas) in the wallet</returns>
        ...
        /// <summary>
        /// Query available amount of the specified asset (global asset,NEP5 asset) in the wallet
        /// </summary>
        /// <param name="asset_id">specified asset id</param>
        /// <returns>available amount of the specified asset in the wallet</returns>
        ...
        // <summary>
        // 查询钱包内所有账户某个全局资产（neo、gas）的余额
        // </summary>
        // <param name="asset_id">指定全局资产的id</param>
        // <returns>指定全局资产的可用余额</returns>
        /// <summary>
        /// Query balance of the specified global asset (neo, gas) in the wallet
        /// </summary>
        /// <param name="asset_id">specified global asset id</param>
        /// <returns>balance of the specified global asset in the wallet</returns>
        ...
        /// <summary>
        /// Select one of the accounts in this wallet as the change address.
        /// The order of selection is the default account first, the account with a signature script, the non-watched account, the ordinary account.
        /// </summary>
        /// <returns>change address</returns>
        ...
        /// <summary>
        /// Query a collection of Coin held by all accounts in the wallet
        /// </summary>
        /// <returns>Coin set</returns>
        ...
        /// <summary>
        /// Decrypt the privatekey from NEP2 string ，and verify password
        /// </summary>
        /// <param name="nep2">NEP2 string</param>
        /// <param name="passphrase">password</param>
        /// <param name="N">Parameter N,a parameter for Scrypt algorithm,default 16384</param>
        /// <param name="r">Parameter r,a parameter for Scrypt algorithm，default 8</param>
        /// <param name="p">Parameter p,a parameter for Scrypt algorithm，default 8</param>
        /// <returns>privatekey</returns>
        /// <exception cref="System.FormatException">verify password unsuccessfully</exception>
        ...
        /// <summary>
        /// Parse privatekey in the WIF string
        /// </summary>
        /// <param name="wif">wif string</param>
        /// <returns>privatekey</returns>
        /// <exception cref="System.ArgumentNullException">wif string is null</exception>
        ...
        /// <summary>
        /// Query the Coin collection of neo which meet the conditions(confirmed, spent, undrawn gas, unfrozen) in all available accounts in the wallet 
        /// </summary>
        /// <returns>Coin set</returns>
        ...
        /// <summary>
        /// Import X509 certificate and use it to create a WalletAccount object
        /// </summary>
        ...
        /// <summary>
        /// Import a Wif string and use it to create a WalletAccount object
        /// </summary>
        /// <param name="wif">Wif string</param>
        /// <returns>WalletAccount object</returns>
        ...
        /// <summary>
        /// Import a NEP2 string and use it to create a WalletAccount object
        /// </summary>
        /// <param name="nep2">NEP2 string</param>
        /// <param name="passphrase">password</param>
        /// <returns>WalletAccount object</returns>
        ...
        /// <summary>
        /// Build a transaction of the specified transaction type
        /// </summary>
        /// <typeparam name="T">transaction type</typeparam>
        /// <param name="tx">transaction</param>
        /// <param name="from">payment account</param>
        /// <param name="change_address">change address</param>
        /// <param name="fee">network free</param>
        ...
        ///  Build a transcation
        /// </summary>
        /// <param name="attributes">transaction attribute list</param>
        /// <param name="outputs">transaction output</param>
        /// <param name="from">payment account</param>
        /// <param name="change_address">change address</param>
        /// <param name="fee">network free</param>
        /// <returns>Transaction object</returns>
        ...
        /// <summary>
        /// Sign data in contract parameter context(transactions, consensus, etc.)
        /// </summary>
        /// <param name="context">ContractParametersContext</param>
        /// <returns>If sign successfully,return true.Otherwise,return false.</returns>
