...
namespace Neo.Cryptography.ECC
{
    ...
    // </summary>
    /// <summary>
    /// This class define the Elliptic curve. According to the different parameter, it defined two curve Secp256k1 and Secp256r1
    /// </summary>
    public class ECCurve
    {
        ...
        /// <summary>
        /// The infinity point of this ECCurve
        /// </summary>
        /// <value>
        /// Return the infinity point of this ECCurve
        /// </value>
        public readonly ECPoint Infinity;

        /// <summary>
        /// The base point of this ECCurve
        /// </summary>
        /// <value>
        /// Return the base point of this ECCurve
        /// </value>
        ...
        // </value>
        /// <summary>
        /// return a Kobliztz Elliptic curve which match the ECG standard.<br/>
        /// The curve is defined in a finite Field F<sub>p</sub>, the relation is y<sup>2</sup> = x<sup>3</sup> +ax + b. where a=0, b=7. <br/> 
        /// The definition of finite P is :P = FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFE FFFFFC2F<para>   </para>
        /// Base point G = 04 79BE667E F9DCBBAC 55A06295 CE870B07 029BFCDB 2DCE28D9 59F2815B 16F81798 483ADA77 26A3C465 5DA4FBFC 0E1108A8 FD17B448 A6855419 9C47D08F FB10D4B8<para>   </para>
        /// The order of base point G: n = FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFE BAAEDCE6 AF48A03B BFD25E8C D036414
        /// </summary>
        /// <value>
        /// return Koblitz Elliptic curve
        /// </value>
        ...
        // </value>
        /// <summary>
        /// return a Random Elliptic curve.<br/>
        /// The curve is defined in a finite Field F<sub>p</sub>, the relation is y<sup>2</sup> = x<sup>3</sup> +ax + b. <br/> 
        /// where a=FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC, b=5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B. <br/> 
        /// The parameter of E is generated randomly through a seed. The seed is : C49D3608 86E70493 6A6678E1 139D26B7 819F7E90
        /// The definition of finite P is :P = FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFE FFFFFC2F<br/>
        /// Base point G = 04 6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296 4FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5 <br/>
        /// The order of base point G:n = FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551
        /// </summary>
        /// <value>
        /// return Random Elliptic curve
        /// </value>
