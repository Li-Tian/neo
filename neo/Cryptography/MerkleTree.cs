...
namespace Neo.Cryptography
{
    ...
    public class MerkleTree
    {
        ...
        /// <summary>
        /// 根据标志位修剪梅克尔树。flags为所有叶节点的标志位。
        /// 如果子树高度为1或者节点的左子树为空时，直接返回；
        /// 对所有高度为2的子树，如果左节点和右节点的标志位都为false,将根节点的左节点和右节点置为null；
        /// 递归检测高度为2以上的子树。如果子树根节点的左节点的左节点和根节点的右节点的右节点都为null时，将子树根节点的左节点和右节点都置为null；
        /// 递归完成后便得到修剪后的梅克尔树。
        /// </summary>
