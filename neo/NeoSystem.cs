...
namespace Neo
{
    ...
    public class NeoSystem : IDisposable
    {
        ...
        // </summary>
        /// <summary>
        /// A system object based on the Akka framework ActorSystem model named NeoSystem
        /// </summary>
        ...
        // </summary>
        /// <summary>
        /// An Actor reference that describes the Blockchain object
        /// </summary>
        ...
        // </summary>
        /// <summary>
        /// An Actor reference that describes the LocalNode object
        /// </summary>
        ...
        // </summary>
        /// <summary>
        /// An Actor reference that describes the TaskManager object
        /// </summary>
        ...
        // </summary>
        /// <summary>
        /// An Actor reference that describes the Consensus object
        /// </summary>
        ...
        // </summary>
        /// <summary>
        /// An Actor reference that describes the RpcServer object
        /// </summary>
        ...
        /// <summary>
        /// Notify the consensus service through the Akka framework to start working
        /// </summary>
        ...
        /// <summary>
        /// Notify the LocalNode through the Akka framework to start working
        /// </summary>
        /// <param name="port">Tcp listening port</param>
        /// <param name="wsPort">WebSocket listening port</param>
        /// <param name="minDesiredConnections">minDesiredConnections</param>
        ...
        /// <param name="wallet">wallet</param>
        /// <param name="sslCert">SSL certificate</param>
        /// <param name="password">SSL certificate password</param>
        /// <param name="trustedAuthorities">trust list</param>
        /// <param name="maxGasInvoke">
        /// max Gas can be invoked.
        /// default value is 0.
        /// Specify the GAS quota that can be used when invoking a  RPC api.
        /// The actual quota is this quota plus 10 gas free quotas.
        /// </param>
