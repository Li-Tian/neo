...
namespace Neo
{
    ...
    public class UInt160 : UIntBase, IComparable<UInt160>, IEquatable<UInt160>
    {
        ...
        // </summary>
        /// <summary>
        /// a UInt160 object with a value of 0
        /// </summary>
        ...
        /// </summary>
        /// <param name="other">another UInt160 object</param>
        /// <returns>Method CompareTo returns 1 if this UInt160 is bigger than other UInt160; -1 if it's smaller; 0 if it's equals</returns>
        ...
        /// <exception cref="FormatException">if the length of hex string is not 40</exception>
        /// <param name="value">a big-endian hex string</param>
        /// <returns>a UInt160 object</returns>
        ...
        /// <param name="result">a UInt160 object used to save the result</param>
        ...
        /// </summary>
        /// <param name="left">a UInt160 object</param>
        /// <param name="right">another UInt160 object</param>
        /// <returns>returns true if left UInt160 is bigger than right UInt160.otherwise,return false</returns>
        ...
        /// <param name="left">a UInt160 object</param>
        /// <param name="right">another UInt160 object</param>
        /// <returns>returns true if left UInt160 is bigger or equals to right UInt160.otherwise,return false</returns>
        public static bool operator >=(UInt160 left, UInt160 right)
        {
            return left.CompareTo(right) >= 0;
        }
        ...
        /// <param name="left">a UInt160 object</param>
        /// <param name="right">another UInt160 object</param>
        /// <returns>returns true if left UInt160 is less than right UInt160.otherwise,return false</returns>
        public static bool operator <(UInt160 left, UInt160 right)
        {
            return left.CompareTo(right) < 0;
        }
        ...
        /// <param name="left">a UInt160 object</param>
        /// <param name="right">another UInt160 object</param>
        /// <returns>returns true if left UInt160 is less or equals to right UInt160.otherwise,return false</returns>
        public static bool operator <=(UInt160 left, UInt160 right)
        {
            return left.CompareTo(right) <= 0;
        }
